...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnEmailVerify,
      @NonNull Button btnQuote, @NonNull Button btnSignOut, @NonNull ImageView ivImage,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnQuote;
      Button btnQuote = rootView.findViewById(id);
      if (btnQuote == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnEmailVerify, btnQuote,
